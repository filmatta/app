...
export default function IdentityImage({ id, fallbackUrl, alt, eager = false }: { id?: string | null; fallbackUrl?: string | null; alt: string; eager?: boolean }) {
  ...
  return <div className="p2-identity-image" ref={ref}>
    ...
    {error && <button type="button" onClick={retry}>Reintentar imagen</button>}
  </div>;
}
