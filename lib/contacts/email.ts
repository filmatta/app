...
export async function notifyNewProfileContact(inquiryId: string, senderId: string): Promise<NotificationResult> {
  if (process.env.CONTACT_EMAIL_NOTIFICATIONS_ENABLED !== "true") return "skipped";
