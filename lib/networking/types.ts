...
export type Summary = { followers: number; following: number; pending_received: number; unread: number };
...
export type NetworkNotification = { id: string; type: string; actor_name: string; has_actor?: boolean; portrait_media_id?: string | null; portrait_url?: string | null; project_title?: string | null; href: string; created_at: string; read_at: string | null };
export type ContactRequest = { id: string; is_recipient: boolean; message: string; state: "pending" | "accepted" | "rejected" | "expired" | "cancelled"; created_at: string; expires_at: string; accepted_at: string | null; contact_unlocked_at: string | null; shared_contact_snapshot: Partial<Record<"instagram" | "whatsapp" | "email" | "phone", string>> | null; project_snapshot: ProjectSnapshot | null; credit_required: boolean; counterpart_name: string; counterpart_slug: string | null; discipline: string | null; city: string | null; portrait_media_id: string | null; portrait_url: string | null };
