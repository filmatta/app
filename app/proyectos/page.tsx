...
export default async function ProjectsPage({ searchParams }: { searchParams: Promise<{ created?: string; saved?: string }> }) {
  const feedback = await searchParams, created = feedback.created === "1", saved = feedback.saved === "1";
